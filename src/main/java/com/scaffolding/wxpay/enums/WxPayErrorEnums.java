...
public enum WxPayErrorEnums {
    ...
    public static WxPayErrorEnums getEnumByStatusCode(Integer statusCode) {
        for (WxPayErrorEnums wxPayErrorEnums : WxPayErrorEnums.values()) {
            if (wxPayErrorEnums.getStatusCode().equals(statusCode)) {
                return wxPayErrorEnums;
            }
        }
        return null;
    }

    public static WxPayErrorEnums getEnumByErrorCode(String errorCode) {
        for (WxPayErrorEnums wxPayErrorEnums : WxPayErrorEnums.values()) {
            if (wxPayErrorEnums.getErrorCode().equals(errorCode)) {
                return wxPayErrorEnums;
            }
        }
        return null;
